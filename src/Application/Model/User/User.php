...
class User extends Aggregate implements UserInterface
{
     ...
     */
    public function __construct(string $username, string $password, UniqueUsernameSpecificationInterface $uniqueUsernameSpecification, array $roles = [self::DEFAULT_USER_ROLE])
    {
