...
namespace App\Tests\Unit\Application\Model\User;
...
class UserTest extends TestCase
{
    ...
    {
        $user = new User(str_repeat('x', User::MAX_USER_NAME_LENGTH), str_repeat('x', User::MAX_PASSWORD_LENGTH), $this->getUniqueUsernameSpecification());
